          ...
          <li key={a.id} className="flex items-start gap-3 py-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1.5 flex flex-wrap gap-2 text-xs">
                ...
                {a.mistakeType !== "NONE" && (
                  <span className="rounded-full bg-amber-400/15 px-2 py-0.5 font-medium text-amber-700">
                    {a.mistakeType.toLowerCase().replace(/_/g, " ")}
                  </span>
                )}
                <span className="text-ink-500">hint lvl {a.hintLevelUsed}</span>
                {a.timeTakenSec !== null && (
                  <span className="text-ink-500">{a.timeTakenSec}s</span>
                )}
              </div>
            </div>
          </li>
