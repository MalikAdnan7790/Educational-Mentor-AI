  ...
  return (
    <div className="space-y-6">
      <section className="flex items-start gap-4">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-orange-400/15 text-orange-500">
          <Clock className="h-5 w-5" />
        </div>
        <div>
          <h1 className="text-2xl font-extrabold text-ink-900">60-Second Teacher</h1>
      ...
      {view === "setup" && (
        <section className="rounded-2xl border-2 border-ink-100 bg-white max-w-xl p-6">
          <h2 className="text-sm font-bold text-ink-900">What should I teach you?</h2>
      ...
      {view === "lesson" && lesson && (
        <section className="rounded-2xl border-2 border-ink-100 bg-white max-w-2xl p-6">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="rounded-2xl border-2 border-ink-200 bg-ink-50/50 p-4">
              <h3 className="text-sm font-bold text-ink-900">Your question</h3>
